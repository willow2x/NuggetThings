...
#if defined(HACKHELD_VEGA) // Modified for WiFiNugget
// ===== LED ===== //
  #define USE_LED true
  #define LED_NEOPIXEL
...
// ===== BUTTONS ===== //
  ...
  #define BUTTON_DOWN 0 // D3
  #define BUTTON_A 14    // D5
  #define BUTTON_B 13     // D7
...
// ===== LED ===== //
 ...
 #define LED_MODE_DEAUTHER_DETECTOR_SUCCES 255,215,0
...
#ifndef LED_MODE_DEAUTHER_DETECTOR_SUCCES 
  #define LED_MODE_DEAUTHER_DETECTOR_SUCCES 255, 215, 0
#endif /* ifndef LED_MODE_DEAUTHER_DETECTOR_SUCCES */
...
#define DEAUTHER_VERSION "custom 2.6.2"
